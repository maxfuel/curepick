    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold">{newInquiries ?? 0}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <p className="text-3xl font-bold">{totalInquiries ?? 0}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
            <CardTitle className="text-base">{t("totalHospitals")}</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-3xl font-bold">{totalHospitals ?? 0}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
            <CardTitle className="text-base">{t("totalServices")}</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-3xl font-bold">{totalServices ?? 0}</p>
          </CardContent>
        </Card>
      </div>
